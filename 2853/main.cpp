//----------------------------------------------------------------------
//
// intsetTest2853.cpp: Test program for EOJ #2853.
//
//----------------------------------------------------------------------
...
/*******************************************/
// IMPORTANT:
//   REPLACE above #include line with your intset.h and intset.cpp here
//   before submitting to EOJ!
...
{   int m,n,d; cin>>n>>m;
    ...
    intset r1{is1.setintsection(is2)}; r1.print(); cout << endl;
    intset r2{is1.setunion(is2)};      r2.print(); cout << endl;
    intset r3{is1.setdifference(is2)}; r3.print(); cout << endl;
    return 0;
}
